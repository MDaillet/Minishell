...
/*   Updated: 2021/11/09 21:43:08 by mdaillet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_append_env(t_list *list, char **t) // += behavior
{
	char	*cut;
	char	*plus;
	char	*old;
...
static char	**ft_equal_mana(char *s) // Split the cmd after export in a double array to have the variable name and its value in tmp[0] and tmp[1]
{
	char	**tmp;
	char	*subs;
